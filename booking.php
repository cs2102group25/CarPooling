...
<body>
    ...
    require_once 'libs.php';
        ...
        if (isset($_POST['book'])) {
            ...
            $deleteQuery = "INSERT INTO booking WHERE p.car_plate IN (
      ...
      <td>
        ...
        <?php 
         ...
         while ($line = pg_fetch_row($result)) {
           ...
           echo "<div class='col-lg-1 col-md-1 result'><button type='submit' name=book value='".$line[1]."_".$line[0]."'] >Book</button></div>";
           echo "</div>";
         }
