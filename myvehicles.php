    ...
    <table class="resultTable">
        <tr>
            <td>
                ...
                $arrayTitle = ['Plate No.', 'Model', 'Delete'];
                echo "<div class='row result'>";

                echo "<div class='col-md-5'>".$arrayTitle[0]."</div>";
                echo "<div class='col-md-5'>".$arrayTitle[1]."</div>";
                echo "<div class='col-md-2'>".$arrayTitle[2]."</div>";
                ...
                if (($vehicleCount = pg_num_rows($vehicleResult)) > 0) {
                    for ($i = 0; $i < $vehicleCount; $i++) {
                        ...
                        echo "<div class='row result'>";
                        echo "<div class='col-md-5'>".$row[0]."</div>";
                        echo "<div class='col-md-5'>".$row[1]."</div>";
                        echo "<div class='col-md-2'><form method='post' action='myvehicles.php'>
